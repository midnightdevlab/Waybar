...
FancyWindowCreationPayload::FancyWindowCreationPayload(Json::Value const& client_data)
...
FancyWindowCreationPayload::FancyWindowCreationPayload(std::string workspace_name,
...
void FancyWindowCreationPayload::clearAddr() {
...
void FancyWindowCreationPayload::clearWorkspaceName() {
...
bool FancyWindowCreationPayload::isEmpty(FancyWorkspaces& workspace_manager) {
...
int FancyWindowCreationPayload::incrementTimeSpentUncreated() { return m_timeSpentUncreated++; }

void FancyWindowCreationPayload::moveToWorkspace(std::string& new_workspace_name) {
  m_workspaceName = new_workspace_name;
}

FancyWindowRepr FancyWindowCreationPayload::repr(FancyWorkspaces& workspace_manager) {
  if (std::holds_alternative<Repr>(m_window)) {
